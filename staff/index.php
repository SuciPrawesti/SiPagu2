    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        ...
        <div class="sidebar-brand">
          <a href="index.html">
            <img src="../assets/img/logoSiPagu.png" alt="Logo" style="max-height: 40px; max-width: 150px; object-fit: contain;">
          </a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
          <a href="index.html">
            <img src="../assets/img/logoSiPagu.png" alt="Logo" style="max-height: 30px; max-width: 40px; object-fit: contain;">
          </a>
        </div>
