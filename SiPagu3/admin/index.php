    ...
    <section class="section">
        ...
        <div class="section-header pt-4 pb-0">
            <div class="d-flex align-items-center justify-content-between w-100">
                <div>
                    <h1 class="h3 font-weight-normal text-dark mb-1">Dashboard</h1>
                ...
                <div class="col-12 mb-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mb-4">
                            <a href="<?= BASE_URL ?>admin/uploads_excel/<?php echo $action['url']; ?>" 
                        ...
                        <div class="card-body">
                            ...
                            <div class="status-item mb-3">
                                <div class="d-flex justify-content-between mb-1">
                                    ...
                                    <span class="text-success font-weight-medium">Normal</span>
                                </div>
                            ...
                            <div class="status-item mb-3">
                                <div class="d-flex justify-content-between mb-1">
                                    ...
                                    <span class="text-warning font-weight-medium">65%</span>
                                </div>
                                <div class="progress-bar-thin">
                            ...
                            <div class="status-item">
                                <div class="d-flex justify-content-between mb-1">
                                    ...
                                    <span class="text-info font-weight-medium">99.8%</span>
                                </div>
                                <div class="progress-bar-thin">
