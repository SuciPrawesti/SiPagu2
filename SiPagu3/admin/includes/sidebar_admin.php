<?php
/**
 * SIDEBAR TEMPLATE - SiPagu (FINAL)
 * Lokasi: admin/includes/sidebar.php
 */
?>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown <?= $is_upload_page ? 'active' : ''; ?>">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'upload_thd.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>admin/upload_thd.php">Upload Jadwal</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'upload_jadwal.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>admin/upload_jadwal.php">Upload Jadwal Lain</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?= BASE_URL ?>admin/users.php">Data User</a></li>
                    <li><a class="nav-link" href="<?= BASE_URL ?>admin/laporan.php">Transaksi Honor Dosen</a></li>
                    <li><a class="nav-link" href="<?= BASE_URL ?>admin/jadwal.php">Jadwal</a></li>
                    <li><a class="nav-link" href="<?= BASE_URL ?>admin/panitia.php">Panitia</a></li>
                </ul>
            </li>
...
.sidebar-footer {
    ...
    position: sticky;
    bottom: 0;
    background: linear-gradient(to top, #fff 60%, rgba(255,255,255,0.9));
    z-index: 10;
